              ...
              <Col xl="8" lg="9" md="11">
                <div className="px-xl-15 px-lg-8 text-center">
                  ...
                  <p className="gr-text-8 mb-13">
                    By accessing and placing an order with Kias Design, you confirm
                ...
                <div className="px-lg-8 px-xl-3">
                  <div className="single-block mb-11">
                    <p className="gr-text-9">
                      By accessing and placing an order with Kias Design, you
                      ...
                      and Kias Design. Under no circumstances shall Kias Design team be
                      ...
                      Kias Design team or an authorized representative has been
                      ...
                      assume any costs thereof. Kias Design will not be responsible
                  ...
                  <div className="single-block mb-11">
                    ...
                    <p className="gr-text-9">
                      ...
                      with Kias Design, and you are required to abide by the
                    ...
                    <ul className="list-unstyled">
                      ...
                      <li className="mt-7">
                        <i
                          ...
                          `}
                        ></i>
                        You are not required to attribute or link to Kias Design in
                        any of projects.
                      </li>
                      <li className="mt-7">
                        <i
